...
*This is correct and organized HTML structure, the structure of the page head,body and foot.

2. Name two big differences between ```display: block;``` and ```display: inline;```.

*Box will fill out entire space given Horizontally Inline will only fill out as much space as needed
...
*It allows all team members access to project to edit and make adjustments as needed.
